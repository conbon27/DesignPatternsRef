...
public class DisplayUpdateTest {
	...
	public void testCurrentConditionsUpdate() {
		...
		/**
		 * CurrentConditionsDisplay display widgets observing the
		 * WeatherData_East object
		 */
		CurrentConditionsDisplay currentDisplay = new CurrentConditionsDisplay(weatherEast);
	...
	public void testStatsUpdate() {
		...
		/**
		 * StatisticsDisplay display widget observing the WeatherData_East
		 * object
		 */
	...
	public void testForeCastUpdate() {
		...
		/**
		 * ForecastDisplay display widgets observing the WeatherData_East object
		 */
